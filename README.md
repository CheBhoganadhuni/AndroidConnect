...
1. **Download the Companion APK**: Download the latest companion APK from the [GitHub Releases](https://github.com/CheBhoganadhuni/AndroidConnect/releases/latest) page (look for `AndroidConnect-v1.7.9.apk`).
...
1. **Download the Mac Bundle**: Download the latest zip release from the [GitHub Releases](https://github.com/CheBhoganadhuni/AndroidConnect/releases/latest) page (look for `AndroidConnect-v1.7.9.zip`) and unzip it to extract `AndroidConnect.app`.
